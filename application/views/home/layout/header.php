...
<head>
    ...
    <!-- Google Web Fonts -->
    <link rel="preconnect" href="<?=base_url()?>assets/home/https://fonts.gstatic.com">
                ...
                <nav class="navbar navbar-expand-lg bg-light navbar-light py-3 py-lg-0 px-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto py-0">
                            <a href="<?php echo site_url('main');?>" class="nav-item nav-link active">Home</a>
                    ...
                    <?php } else { ?>
                        <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto py-0">
                            <a href="<?php echo site_url('main');?>" class="nav-item nav-link active">Beranda</a>
                            <a href="<?php echo site_url('toko');?>" class="nav-item nav-link">Toko</a>
                            <a href="<?php echo site_url('order');?>" class="nav-item nav-link">Transaksi</a>
                    </div>
                    <div class="navbar-nav ml-auto py-0">
                        <a href="<?php echo site_url('main/logout');?>" class="nav-item nav-link">Logout</a>
                        <a href="<?php echo site_url('main/edit/'.$this->session->userdata('idKonsumen'));?>" class="nav-item nav-link">Edit</a>
                    </div>
                    </div>
                    <?php } ?>
                </nav>
