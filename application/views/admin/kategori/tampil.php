                    ...
                    <div class="card">
                            ...
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <!-- <div class="btn-group">
                                                <a href="<?php echo site_url('kategori/get_by_id/'.$val->idKat);?>"
                                                    class="btn btn-warning">Edit</a>
                                                <a href="<?php echo site_url('kategori/delete/'.$val->idKat);?>"
                        ...
                        <div class="card-footer clearfix">
                            <a href="<?php echo site_url('kategori/add'); ?>"
                                class="btn btn-sm btn-info float-left">Tambah Kategori</a>
